...
const About = () => {
  ...
  <div className="py-20 px-4 max-w-6xl mx-auto">
    ...
    Asutay Estate is a leading real estate agency that specializes in helping cilents 
    buy,sell,and rent properties in the most desirable neighborhoods. Our team of experienced 
    agents is dedicated to providing exceptional service and making the buying and selling process as smooth as possible
    </p>
    <p className="mb-4 text-slate-700">
    ...
    a property should be an exciting and rewarding experience, and we are dedicated to making that a reality 
